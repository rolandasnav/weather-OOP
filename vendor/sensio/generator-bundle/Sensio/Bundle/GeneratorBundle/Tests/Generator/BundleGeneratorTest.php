...
class BundleGeneratorTest extends GeneratorTest
{
    public function testGenerateYaml()
    {
        ...
        $files = array(
            ...
            'Resources/views/Weather/index.html.twig',
        ...
        $content = file_get_contents($this->tmpDir.'/Foo/BarBundle/Controller/WeatherController.php');
        $this->assertContains('public function indexAction', $content);
        $this->assertNotContains('@Route("/hello/{name}"', $content);

        $content = file_get_contents($this->tmpDir.'/Foo/BarBundle/Resources/views/Weather/index.html.twig');
